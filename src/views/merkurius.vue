<template>
  <div class="planet-container">
    <!-- Tombol Back -->
    <router-link to="/materi/matahari" class="btn-back">BACK◂</router-link>

    <!-- Judul -->
    <div class="planet-title">Merkurius</div>

    <div class="planet-content">
      <!-- Gambar Planet -->
      <div class="planet-image">
        <img src="@/assets/Merkurius.png" alt="Merkurius" />
      </div>

      <!-- Deskripsi -->
      <div class="planet-desc">
        <p>Merkurius adalah planet terkecil dan terdekat dengan Matahari.</p>
      </div>
    </div>

    <!-- Tombol Next -->
    <router-link to="/materi/venus" class="btn-next">▶</router-link>
...
export default {
  ...
  data() {
    return {
      voiceOverSrc: require('@/assets/Merkurius.mp3')
    };
  },
  mounted() {
    this.playVoiceOver();
